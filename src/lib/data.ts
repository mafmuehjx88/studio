...
export const games: Game[] = [
  ...
  { id: 'digital-product', name: 'Digital Product', image: 'https://picsum.photos/seed/4/400/400', bannerImage: 'https://picsum.photos/seed/digital-banner/600/300', needsServerId: false },
];
